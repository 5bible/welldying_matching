...
class _FmDetailPageState extends State<FmDetailPage> {
  ...
  Widget _buildServiceCard(IconData icon, String title, String subtitle, bool value, ValueChanged<bool> onChanged) {
    return Container(
      height: 100, // 높이를 110에서 100으로 더 줄임
      ...
      child: Column(
        ...
        children: [
          Icon(icon, color: AppColors.accent, size: 16), // 아이콘 크기를 18에서 16으로 줄임
          Column(
            children: [
              Text(
                title,
                style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 10), // 폰트 크기를 11에서 10으로 줄임
              ...
              Text(
                subtitle,
                style: const TextStyle(fontSize: 8, color: AppColors.textGrey), // 폰트 크기를 9에서 8로 줄임
                textAlign: TextAlign.center,
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
              ),
          ...
          Transform.scale(
            scale: 0.6, // 스위치 크기를 0.7에서 0.6으로 더 줄임
            child: Switch(
              value: value,
              onChanged: onChanged,
              activeColor: AppColors.brown,
