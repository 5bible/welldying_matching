...
class _FmReservationPageState extends State<FmReservationPage> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.assignment, color: AppColors.accent, size: 24),
              const SizedBox(width: 8),
              const Text(
                '선택한 예약 정보',
                style: TextStyle(fontSize: 18, fontWeight: FontWeight.w700),
          ...
          // 시설명
          _buildSummaryRow('시설명', '평안 동물병원 장례식장'),
          
          // 신청자 정보
          _buildSummaryRow('신청자', _nameController.text),
          ...
          // 서비스
          _buildSummaryRow('서비스', selectedService),
  ...
  void _submitReservation() {
    ...
    // 예약 완료 화면으로 바로 이동
    Navigator.pushReplacementNamed(context, '/funeral/complete');
  }
}